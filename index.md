### Contact Information
```
5-517, Two Building<br />
Westlake University (Yunqi Campus)<br />
Shilongshan Road No.18, Cloud Town, Xihu District, Hangzhou, Zhejiang, China

Email: zmin.remi AT gmail DOT com
```

### Biography
 I am a post graduate student from department of Electronics & Communication Engineering (ECE) at [Tianjin Normal University (TJNU)](http://www.tjnu.edu.cn/). My researches involve Multi-modal learning, signal process, radio charging, wireless communication and networks. Furthermore, I have broad interests in optimization and decision. In 2016.9, I joined USTC ECE, where I was fortunate for having been directed by Prof. Chen Gong, and my research topics include signal processing, multiple access communication and media access control. Before this, I finished my undergraduate study in Dalian University of Technology (DUT), where my researches focused on automatic driving of photoelectrical smart car. From 2019.7 to 2019.9, I was working as an intern in Magcharging Inc. There I was fortunate to be directed by Prof. Xiaodong Wang from Columbia University and finished a prototype machine of radio frequency wireless charging system. Now, I am working as a research assistance in the Machine Intellignece Lab in [SoE-Westlake university](https://www.wias.org.cn/english/). I am fortunate to be supervised by Prof. [Donglin Wang](https://www.westlake.edu.cn/info/1408/3011.htm), and my research focuses on Few-shot learning algorithms for robotics.
